...
// RemoveUserList is needed to comply with the interface
func (m *MockDatabase) RemoveUserList(ID string, listID int) error {
	args := m.Called(ID, listID)
	return args.Error(0)
}

// InsertUserFavorite is needed to comply with the interface
